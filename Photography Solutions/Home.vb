...
Public Class Home
    ...
    Private Sub Home_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        sqlConexion.ConnectionString = "workstation id = " & Dns.GetHostName & "; packet size = 8192; user id = AdminPS; data source = localhost,1433; persist security info = False; initial catalog = PhotographySolutions; password= Admin123!; pooling =FALSE"
        sqlConexion.Open()
        ...
        sqlcmdComando.CommandText = "sp_ConsultasAvanzadas 1,''," & IdUsuario
